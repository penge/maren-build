...
test('build', async () => {
  ...
  [
    ...
    path.join(cwd, '_build', 'categories', 'business', 'economics', 'index.html'),
    path.join(cwd, '_build', 'categories', 'business', 'finance', 'index.html'),
    path.join(cwd, '_build', 'categories', 'business', 'industries', 'index.html'),
    path.join(cwd, '_build', 'categories', 'business', 'index.html'),
    path.join(cwd, '_build', 'categories', 'history', 'index.html'),
    path.join(cwd, '_build', 'categories', 'travel', 'index.html'),
    path.join(cwd, '_build', 'contact', 'index.html'),
    path.join(cwd, '_build', 'news', 'index.html'),
    path.join(cwd, '_build', 'support', 'index.html'),
